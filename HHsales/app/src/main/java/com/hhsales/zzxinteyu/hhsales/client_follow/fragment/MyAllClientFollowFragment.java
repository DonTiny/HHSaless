...
import com.hhsales.zzxinteyu.hhsales.client_follow.presenter.MyAllClientFollowPresenter;
...
public class MyAllClientFollowFragment extends BaseFragment<IMyAllClientFollowFragment,MyAllClientFollowPresenter> implements IMyAllClientFollowFragment,View.OnClickListener, AdapterView.OnItemClickListener {
    @Nullable
    @Override
    ...
    @Override
    protected MyAllClientFollowPresenter createPresenter() {
        return new MyAllClientFollowPresenter();
    }
