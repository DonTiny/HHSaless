...
import com.hhsales.zzxinteyu.hhsales.client_follow.presenter.MyShareClientFollowPresenter;
...
public class MyShareClientFollowFragment extends BaseFragment<IMyShareClientFollowFragment,MyShareClientFollowPresenter> implements IMyShareClientFollowFragment,View.OnClickListener, AdapterView.OnItemClickListener {
    @Nullable
    @Override
    ...
    @Override
    protected MyShareClientFollowPresenter createPresenter() {
        return new MyShareClientFollowPresenter();
    }
