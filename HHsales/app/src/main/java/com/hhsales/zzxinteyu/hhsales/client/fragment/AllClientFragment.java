...
public class AllClientFragment extends BaseFragment<IMyClientFragment, MyClientFragmentPresenter> implements IMyClientFragment, IEmptyLayout, View.OnClickListener, AdapterView.OnItemClickListener {
