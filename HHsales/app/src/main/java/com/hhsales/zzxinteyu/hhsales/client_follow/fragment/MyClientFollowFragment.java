...
import com.hhsales.zzxinteyu.hhsales.client_follow.presenter.MyClientFollowPresenter;
...
public class MyClientFollowFragment  extends BaseFragment<IMyClientFollowFragment,MyClientFollowPresenter> implements IMyClientFollowFragment, View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    @Override
    protected MyClientFollowPresenter createPresenter() {
        return new MyClientFollowPresenter();
    }
    @Override
    public void onClick(View v) {
        int i = v.getId();
