...
import com.hhsales.zzxinteyu.hhsales.client_follow.presenter.PubClientPresenter;
...
public class PubClientFragment  extends BaseFragment<IPubClientFragment,PubClientPresenter> implements IPubClientFragment, View.OnClickListener, AdapterView.OnItemClickListener {
    @Nullable
    @Override
    ...
    @Override
    protected PubClientPresenter createPresenter() {
        return new PubClientPresenter();
    }
